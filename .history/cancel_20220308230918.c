...
//  Input a room to cancel
    ...
    while (fgets(line, lineLength, f)) {
		...
		checkin2.yy = strtok(NULL, ", ");
		name2 = strtok(NULL, ", ");
		birth2.dd = strtok(NULL, "/");
		birth2.mm = strtok(NULL, "/");
		birth2.yy = strtok(NULL, ", ");
		sex2 = strtok(NULL, ", ");
		phone2= strtok(NULL, ", ");
		email2 = strtok(NULL, ", ");
		service_in_use2[0] = strtok(NULL, ", ");
		service_in_use2[1] = strtok(NULL, ", ");
		service_in_use2[2] = strtok(NULL, ", ");
		service_in_use2[3] = strtok(NULL, ", ");
		service_in_use2[4] = strtok(NULL, ", ");
		total_pay2 = strtok(NULL, ", ");

		printf("%d", s.longstay2);
	}
